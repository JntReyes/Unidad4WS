...
public class MovieWS extends AppCompatActivity implements View.OnClickListener {
    ...
    static String URL =
            "http://192.168.24.105:8080/WSMovie/services/MoviesWS";
    ...
    private void components() {
        ...
        tbCategory = (ToggleButton)findViewById(R.id.tb_category);
    ...
    protected void onResume() {
        ...
        try {
            ...
            if (datosRegreso.getString("valor3").equals("1")) {
                tbCategory.setChecked(false);
            } else {
                tbCategory.setChecked(true);
            }
